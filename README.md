...
Then, the `nantrobot_servers` package consist of a few python servers that interract with the GPIO or the ESP32 (to be completed with other features)
...
- Add the simulation
- Simulate the GPIO action servers
- Integrate the Lidar
